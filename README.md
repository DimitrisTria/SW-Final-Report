...
3. Δυνατότητα αναζήτησης του δωρητή όταν γίνει κλικ σε έναν κύκλο ή από το ιστορικό
...
6. Νέα οπτικοποίηση των δεδομένων του αρχείου (7500up.csv) με λειτουργία της πίτας για κάθε προηγούμενη ομαδοποίηση
...
8. Επιπλέον γράφημα d3 τύπου ραβδογράμματος που λειτουργεί για κάθε προηγούμενη ομαδοποίηση
![barchart_groups](/photos/barchart_groups.gif)

9. Αρχικό γράφημα με νέα ανοικτά δεδομένα από επίσημη στατιστική αρχή
![bublechart2](/photos/bublechart2.png)

10. Λειτουργία της οπτικοποίησης για κάθε προηγούμενη ομαδοποίηση
