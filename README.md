...
1. Πρώτη εικόνα της εφαρμογής, καθώς και της πρώτου γραφήματος οπτικοποίησης δεδομένων.
![bublechart1](/photos/bublechart1.png)

2. Δυνατότητα μεγένθυσης του κειμένου στη σελίδα όπου υπάρχει κείμενο.
![text_zoom](/photos/text_zoom.png)

3. Δυνατότητα αναζήτησης του δωρητή όταν γίνει κλικ σε έναν κύκλο ή από το ιστορικό (για όλα τα γραφήματα εκτός του ραβδογράμματος)
![search](/photos/search.png)

4. Νέα ομάδα για οπτικοποίηση.
![new_group](/photos/new_group.png)

5. Ιστορικό που ανανεώνεται δυναμικά (για το αρχικό γράφημα και τη διαδραστική πίτα)
...
2. [Νέο γράφημα οπτικοποίησης δεδομένων: διαδρασική πίτα](http://bl.ocks.org/vgrocha/1580af34e56ee6224d33 '1580af34e56ee6224d33')
