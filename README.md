...
9. Επιπλέον γράφημα d3 τύπου ραβδογράμματος
![barchart](/photos/barchart.png)

10. Λειτουργία του ραβδογράμματος για κάθε προηγούμενη ομαδοποίηση
![barchart_groups](/photos/barchart_groups.gif)

11. Αρχικό γράφημα με νέα ανοικτά δεδομένα από επίσημη στατιστική αρχή
