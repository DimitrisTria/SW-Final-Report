...
## Ανάλυση σχετικών έργων και εργαλείων
  Αξίζει να αναφερθεί ότι τα λογισμικά που ακολουθούν είναι ανοικτού κώδικα.
...
8. Αρχικό γράφημα, (bublechart), με νέα ανοικτά δεδομένα από επίσημη στατιστική αρχή, καθώς και τρεις ομαδοποιήσεις πάνω σε αυτά
