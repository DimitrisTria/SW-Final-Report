...
7. Νέα οπτικοποίηση των δεδομένων του αρχείου (7500up.csv) με λειτουργία της πίτας για κάθε προηγούμενη ομαδοποίηση
...
9. Επιπλέον γράφημα d3 τύπου ραβδογράμματος που λειτουργεί για κάθε προηγούμενη ομαδοποίηση
![barchart_groups](/photos/barchart_groups.gif)

10. Αρχικό γράφημα με νέα ανοικτά δεδομένα από επίσημη στατιστική αρχή
![bublechart2](/photos/bublechart2.png)

11. Λειτουργία της οπτικοποίησης για κάθε προηγούμενη ομαδοποίηση
