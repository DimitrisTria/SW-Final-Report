...
### Παραδοτέο 2
* Όταν το ποντίκι εισέρχεται σε έναν από τους κύκλους του γραφήματος γίνεται καταγραφή σε μια περιοχή της σελίδας με την εικόνα και το όνομα, το οποίο φαίνεται όταν κάνει κάποιος αιώρηση με το δείκτη πάνω σε αυτή
