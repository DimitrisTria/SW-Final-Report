...
5. Ιστορικό που ανανεώνεται δυναμικά (για το, αρχικό, bublechart και το piechart)
...
7. Δυνατότητα αναζήτησης του δωρητή όταν γίνει κλικ σε έναν μέρος της πίτας.
![piechart_search](/photos/piechart_search.png)

8. Επιπλέον γράφημα d3 τύπου ραβδογράμματος που λειτουργεί για κάθε προηγούμενη ομαδοποίηση με στατιστικά δεδομένα
![barchart_groups](/photos/barchart_groups.gif)

9. Αρχικό γράφημα με νέα ανοικτά δεδομένα από επίσημη στατιστική αρχή με τρεις ομαδοποιήσεις δεδομένων
